                ...
                if ($archive->have_posts()):
                    ...
                    if ($archive->max_num_pages > 1): ?>
                        <div id="vi-wpb_nav_below" class="navigation">
                            <div
                                class="nav-previous"><?php next_posts_link(__('Next <span class="meta-nav">&larr;</span>', 'woocommerce-product-builder')); ?></div>
                            <div
                                class="nav-next"><?php previous_post_link(__('<span class="meta-nav">&larr;</span> Previous', 'woocommerce-product-builder')); ?></div>
                        </div>
                    <?php endif;
                    wp_reset_postdata();
                else:
